...
class Doctor(models.Model):
    ...
    data = models.ForeignKey(Data, models.DO_NOTHING, null=True)
    specialization = models.CharField(max_length=50)
    clinic = models.ForeignKey(Clinic, models.DO_NOTHING, null=True)
...
class Appointment(models.Model):
    ...
    doctor = models.ForeignKey(Doctor, models.DO_NOTHING, null=True)
